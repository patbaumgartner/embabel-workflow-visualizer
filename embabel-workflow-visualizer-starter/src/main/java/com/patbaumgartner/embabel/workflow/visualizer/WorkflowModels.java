...
public final class WorkflowModels {
	...
	public record WorkflowStep(String name, String type, String description, String method, List<String> pre,
			...
			List<String> possibleOutputs, boolean canRerun, boolean readOnly, String outputBinding,
			boolean clearBlackboard, List<String> tags, List<String> examples, boolean llmTool,
			String llmToolDescription) {
	}
