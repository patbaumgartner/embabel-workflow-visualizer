 ...
 * reflection</li>
 * <li>{@link EmbabelWorkflowActuatorEndpoint} — exposes the catalog as an
 * actuator
 * endpoint ({@code /actuator/embabel})</li>
 * <li>{@link EmbabelWorkflowApiController} — REST API at
 * {@code /embabel-workflows/api};
 * enabled by setting {@code embabel.workflow.visualizer.enabled=true}</li>
 * <li>{@link WorkflowVisualizerPageController} — serves the visualizer HTML
 * page;
 * enabled by setting {@code embabel.workflow.visualizer.enabled=true}</li>
 * </ul>
 */
