...
public class LoanModels {
	...
	/**
	 * Result of the automated credit profile analysis. debtToIncomeRatio: monthly debt /
	...
	/**
	 * Final loan decision. decision: APPROVED, REJECTED, or REFERRED. approvedAmount and
